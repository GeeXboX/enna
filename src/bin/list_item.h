...
EAPI void           enna_listitem_create_simple( Evas_Object *obj, Evas_Object *icon, const char *label);
EAPI void           enna_listitem_create_full( Evas_Object *obj,  Evas_Object *icon,  const char *info,  const char *title, const char *album, const char *artist);
