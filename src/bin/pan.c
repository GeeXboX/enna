...
EAPI void
enna_pan_child_set(Evas_Object *obj, Evas_Object *child)
{
   API_ENTRY return;
...
EAPI Evas_Object *
enna_pan_child_get(Evas_Object *obj)
{
...
EAPI void
enna_pan_set(Evas_Object *obj, Evas_Coord x, Evas_Coord y)
{
   API_ENTRY return;
...
EAPI void
enna_pan_get(Evas_Object *obj, Evas_Coord *x, Evas_Coord *y)
{
   API_ENTRY return;
   if (x) *x = sd->px;
   if (y) *y = sd->py;
...
EAPI void
enna_pan_max_get(Evas_Object *obj, Evas_Coord *x, Evas_Coord *y)
{
   API_ENTRY return;
   if (x)
     {
...
EAPI void
enna_pan_child_size_get(Evas_Object *obj, Evas_Coord *w, Evas_Coord *h)
{
   API_ENTRY return;
   if (w) *w = sd->child_w;
   if (h) *h = sd->child_h;
