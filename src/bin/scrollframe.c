...
EAPI Evas_Object *
enna_scrollframe_add(Evas *evas)
{
   _e_smart_init();
...
EAPI void
enna_scrollframe_child_set(Evas_Object *obj, Evas_Object *child)
{
   Evas_Coord w, h;
   Evas_Object *o;
...
EAPI void
enna_scrollframe_custom_theme_set(Evas_Object *obj, char *custom_category, char *custom_group)
{
   API_ENTRY return;

   edje_object_file_set(sd->edje_obj, enna_config_theme_get(), "e/widgets/scrollframe");
   if (sd->pan_obj)
     edje_object_part_swallow(sd->edje_obj, "e.swallow.content", sd->pan_obj);
...
EAPI void
enna_scrollframe_custom_edje_file_set(Evas_Object *obj, char *file, char *group)
{
   API_ENTRY return;
...
EAPI void
enna_scrollframe_child_pos_set(Evas_Object *obj, Evas_Coord x, Evas_Coord y)
{
...
EAPI void
enna_scrollframe_child_pos_get(Evas_Object *obj, Evas_Coord *x, Evas_Coord *y)
{
   API_ENTRY return;
...
EAPI void
enna_scrollframe_child_viewport_size_get(Evas_Object *obj, Evas_Coord *w, Evas_Coord *h)
{
   API_ENTRY return;
...
EAPI void
enna_scrollframe_step_size_get(Evas_Object *obj, Evas_Coord *x, Evas_Coord *y)
{
   API_ENTRY return;
   if (x) *x = sd->step.x;
   if (y) *y = sd->step.y;
...
EAPI void
enna_scrollframe_page_size_set(Evas_Object *obj, Evas_Coord x, Evas_Coord y)
{
   API_ENTRY return;
   sd->page.x = x;
   sd->page.y = y;
...
EAPI void
enna_scrollframe_page_size_get(Evas_Object *obj, Evas_Coord *x, Evas_Coord *y)
{
   API_ENTRY return;
   if (x) *x = sd->page.x;
   if (y) *y = sd->page.y;
...
EAPI void
enna_scrollframe_policy_set(Evas_Object *obj, Enna_Scrollframe_Policy hbar, Enna_Scrollframe_Policy vbar)
{
   API_ENTRY return;
...
EAPI void
enna_scrollframe_policy_get(Evas_Object *obj, Enna_Scrollframe_Policy *hbar, Enna_Scrollframe_Policy *vbar)
{
   API_ENTRY return;
...
EAPI Evas_Object *
enna_scrollframe_edje_object_get(Evas_Object *obj)
{
...
EAPI void
enna_scrollframe_event_key_down(Evas_Object *obj, void *event_info)
{
